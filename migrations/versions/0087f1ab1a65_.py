...
Revision ID: 0087f1ab1a65
Revises: 
Create Date: 2021-04-20 10:36:03.087635
...
def upgrade():
    ...
    sa.Column('colour', sa.String(length=200), nullable=True),
    sa.Column('year', sa.String(length=100), nullable=True),
    sa.Column('transmission', sa.String(length=200), nullable=True),
